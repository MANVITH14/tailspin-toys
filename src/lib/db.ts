 ...
 *
 * @param sqlite SQLite connection that executes the migration statements.
 * @param queries SQL statements generated by Drizzle Kit.
 */
...
/**
 * Return the shared database client used by pages at build time.
 *
