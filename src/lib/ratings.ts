 ...
 * @returns The rating constrained to the 0–5 range.
 */
 ...
 *
 * @param rating Rating to format, or `null` when no rating exists.
 * @returns A five-position star string or the not-rated label.
 */
